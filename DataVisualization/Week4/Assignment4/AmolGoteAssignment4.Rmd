...
b. Above grade 10 over the period of time there has steep rise in the prices, especially decade of 1990 and 2000. Also post 1970 houses built post 1970 were grade 5 and above.
c. In genral if consider all the data points instead of average it is evident that increase in grade does increase the price. for e.g below visualization shows overall trend of price and grade.
...
ggplot(averagePriceDecadeCondition, aes(x = condition, y = averagePrice)) +
    ...
    theme_minimal()
```
a. In general across time condition does impact the house price, better the condition higher the price.
