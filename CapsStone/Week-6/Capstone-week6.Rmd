...
auc_df_temp <- data.frame("algorithm_method" = c("glmnet_1"), "auc" = c(glmnet_auc)  * 100, "accuracy" = c(glmnet_accuracy) * 100,"notes" = c("Default"))
auc_df <- rbind(auc_df,auc_df_temp)
...
auc_df_temp <- data.frame("algorithm_method" = c("rf_4"), "auc" = c(rf_auc_4) * 100, "accuracy" = c(rf_accuracy_4) * 100,"notes" = c("Trees = 100 and Only important variables"))
auc_df <- rbind(auc_df,auc_df_temp)
