...
target_company_row_1 <- subset(target_company_row, select = -c(gvkey,tic, sp_rating,
                                                              restmt_at,
                                                              restmt_capx,
                                                              restmt_cogs,
                                                              restmt_dltt,
...
set.seed(123)
tree_model_1 <- rpart(litigated ~ ., data = training_subset_ds_final, method = "class")
...
auc_df_temp <- data.frame("algorithm_method" = c("tree_1"), "auc" = c(tree_auc) * 100, "accuracy" = c(tree_accuracy) * 100,"notes" = c("Default"))
auc_df <- rbind(auc_df,auc_df_temp)
