...
```{r logistic_regression_qda_roc_curve, MESSAGE = FALSE, warning=FALSE}
 qda_rocr_pred <- prediction(test_subset_ds_final$class_probabilities_onehot, test_subset_ds_final$litigated)
 qda_rocr_roc <- performance(qda_rocr_pred, measure = "tpr", x.measure = "fpr")
 plot(qda_rocr_roc,
 colorize = TRUE,
 print.cutoffs.at = seq(0, 1, by = 0.1),
 text.adj = c(-0.5, 1),
 ...
 abline(a = 0, b = 1)
```
```{r logistic_regression_qda_auc_r, MESSAGE = FALSE, warning=FALSE}
 qda_rocr_auc <- performance(qda_rocr_pred, measure = "auc")
 qda_auc <- qda_rocr_auc@y.values[[1]]
 qda_auc
```
