...
grid.arrange(metformin, repaglinide,nateglinide,chlorpropamide,glimepiride,acetohexamide, ncol=3)
...
grid.arrange(glipizide, glyburide,tolbutamide,pioglitazone,rosiglitazone,acarbose, ncol=3)
...
```{r random_forest_2_over_sampling}
rfControl <- trainControl(method = "oob", classProbs = TRUE)
...
```{r random_forest_2_under_sampling}
rfControl <- trainControl(method = "oob", classProbs = TRUE)
...
```{r random_forest_2_over_under_sampling}
rfControl <- trainControl(method = "oob", classProbs = TRUE)
...
auc_df_temp <- data.frame("algorithm_method" = c("rf_over"), "auc" = c(auc_rf_over))
auc_df <- rbind(auc_df,auc_df_temp)
auc_df_temp <- data.frame("algorithm_method" = c("rf_under"), "auc" = c(auc_rf_under))
auc_df <- rbind(auc_df,auc_df_temp)
auc_df_temp <- data.frame("algorithm_method" = c("rf_both"), "auc" = c(auc_rf_both))
auc_df <- rbind(auc_df,auc_df_temp)
auc_df_temp <- data.frame("algorithm_method" = c("nn"), "auc" = c(auc_nn))
auc_df <- rbind(auc_df,auc_df_temp)
auc_df_temp <- data.frame("algorithm_method" = c("nn_over"), "auc" = c(auc_nn_over))
auc_df <- rbind(auc_df,auc_df_temp)
auc_df_temp <- data.frame("algorithm_method" = c("nn_under"), "auc" = c(auc_nn_under))
auc_df <- rbind(auc_df,auc_df_temp)
auc_df_temp <- data.frame("algorithm_method" = c("nn_both"), "auc" = c(auc_nn_both))
auc_df <- rbind(auc_df,auc_df_temp)
