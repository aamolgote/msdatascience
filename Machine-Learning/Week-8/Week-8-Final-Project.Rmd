...
gbm_model <- train(x = training_subset_ds_final[, -1*c(target_var_index:target_var_index)], y = training_subset_ds_final[, target_var_index],
                  method = "gbm",
...
```{r gbm_2}
test_subset_ds_final$prediction_onehot <- predict(gbm_model, newdata = test_subset_ds_final[, -1*c(target_var_index:target_var_index)])
...
auc_df_temp <- data.frame("algorithm_method" = c("gbm"), "auc" = c(auc_gbm))
auc_df <- rbind(auc_df,auc_df_temp)
