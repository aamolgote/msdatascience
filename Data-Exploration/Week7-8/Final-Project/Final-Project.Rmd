...
p2 <- fviz_cluster(list(data = customers.for.analysis_hierarchy, cluster = clust2)) + ggtitle("k = 2")

clust3 <- cutree(hc4, k = 3)
p3 <- fviz_cluster(list(data = customers.for.analysis_hierarchy, cluster = clust3)) + ggtitle("k = 3")  

clust4 <- cutree(hc4, k = 4)
p4 <- fviz_cluster(list(data = customers.for.analysis_hierarchy, cluster = clust4)) + ggtitle("k = 4")  

clust5 <- cutree(hc4, k = 5)
p5 <- fviz_cluster(list(data = customers.for.analysis_hierarchy, cluster = clust5)) + ggtitle("k = 5")  

clust6 <- cutree(hc4, k = 6)
p6 <- fviz_cluster(list(data = customers.for.analysis_hierarchy, cluster = clust6)) + ggtitle("k = 6")

clust7 <- cutree(hc4, k = 7)
p7 <- fviz_cluster(list(data = customers.for.analysis_hierarchy, cluster = clust7)) + ggtitle("k = 7")  

clust8 <- cutree(hc4, k = 8)
p8 <- fviz_cluster(list(data = customers.for.analysis_hierarchy, cluster = clust8)) + ggtitle("k = 8")

clust9 <- cutree(hc4, k = 9)
p9 <- fviz_cluster(list(data = customers.for.analysis_hierarchy, cluster = clust9)) + ggtitle("k = 9")
