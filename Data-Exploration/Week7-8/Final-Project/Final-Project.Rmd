...
#ggplot(data=customersFiltered, aes(x=category, y=totalCount, fill=EquipmentRental)) +
...
ggplot(groupedData, aes(x = CardSpendMonth, y = totalMonthlyValue)) + 
  ...
  geom_smooth(method = lm) + 
  facet_wrap(~category) +
  labs( title= "Average Monthly revenue generated to Debt To Income Ratio", x="Debt To Income Ratio", y = "Average Monthly revenue ($)") +
  scale_x_continuous(labels = comma) +
  theme_minimal() 
...
ggplot(customers, aes(x = PhoneCoTenure, y = CardTenure)) + 
  ...
  geom_smooth(method = lm) + 
  facet_wrap(~category) +
  labs( title= "Average Monthly revenue generated to Debt To Income Ratio", x="Phone Company Tenure", y = "Credit card tenue") +
  scale_x_continuous(labels = comma) +
  theme_minimal() 
