...
```
  ...
  2. If you look at the actual data, mahority of the points are near the line with exception of tails which is 
...
```
  ...
  2. Note that normal probability plots C and D have a slight stepwise pattern.Why do you think this is the case?
    ...
    Stepwise patterns is obseved when data is discrete. Data type associated with C and D are different, elbow 
